...
#define __fhep_ILorentzVector_h__
...
namespace fhep {
  ...
  inline float y() const { return _fP4.v[0]; }

  inline void setX(float& x) { _fP4.v[1] = x; }
  inline void setY(float& y) { _fP4.v[2] = y; }
  inline void setZ(float& z) { _fP4.v[3] = z; }
  inline void setT(float& t) { _fP4.v[0] = t; }
